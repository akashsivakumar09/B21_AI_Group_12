Feature: Plant Management UI for Admin
  ...
  @UI-PLANTS-A-03 @admin @plant @validation
  ...
  @UI-PLANTS-A-04 @admin @plant @validation
  ...
  @UI-PLANTS-A-05 @admin @plant @navigation
  ...
  @UI-PLANTS-A-06 @admin @plant @delete

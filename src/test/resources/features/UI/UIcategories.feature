Feature: Category Management UI
  ...
  @UI-CAT-03 @admin @category @validation
  ...
  @UI-CAT-04 @admin @category @validation
  ...
  @UI-CAT-05 @admin @category @validation
  ...
  @UI-CAT-06 @admin @category @validation
  ...
  @UI-CAT-07 @admin @category @validation
  ...
  @UI-CAT-08 @admin @category @navigation
